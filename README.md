...
| 🏢 Multi-agent build pipeline | [`DevCorp`](./skills/devcorp) — original skill + 7 subagents, model-routed (haiku recon → sonnet build → opus plan/audit), gated on [clean code, OOP + SOLID, and agile discipline](./skills/devcorp/references/clean-code.md) |
...
flowchart LR
    ...
    CC[["clean-code.md<br/>SRP · DRY · naming<br/>OOP-when-it-earns-it<br/>SOLID · YAGNI"]]
